...
{
    public static void RemoveDuplicates(List<double> list)
    {
        if (list == null)
        {
    ...
    public static LinkedList<double> BuildDouble(List<double> singleList)
    {
    ...
    public static void GenerateElectivesData(out string[] allElectives, out List<string[]> studentChoices)
    {
        ...
        for (int i = 0; i < studentsCount; i++)
        {
            ...
            {
                string randomSubject = allElectives[rnd.Next(allElectives.Length)];
    ...
    public static void SolveGasTask(string filePath)
    {
        if (ValidateFile(filePath))
        {
            ...
            if (!int.TryParse(allLines[0], out int n)) return;
    ...
    public static void PrintLinkedList(LinkedList<double> list)
    {
        foreach (double item in list) Console.Write(item + " ");
        Console.WriteLine();
    }
